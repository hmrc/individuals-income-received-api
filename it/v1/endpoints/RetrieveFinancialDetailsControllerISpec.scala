    ...
    "return error according to spec" when {
      ...
      "des service error" when {
        ...
        val input = Seq(
          ...
          (BAD_REQUEST, "INVALID_DATE_RANGE", UNPROCESSABLE_ENTITY, RuleTaxYearNotSupportedError),
          (BAD_REQUEST, "TAX_YEAR_NOT_SUPPORTED", UNPROCESSABLE_ENTITY, RuleTaxYearNotSupportedError),
