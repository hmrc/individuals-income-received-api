...
import v1r7.fixtures.RetrieveAllResidentialPropertyCgtControllerFixture
import v1r7.models.errors._
import v1r7.stubs.{AuditStub, AuthStub, DownstreamStub, MtdIdLookupStub}

class RetrieveAllResidentialPropertyCgtControllerISpec extends V1R7IntegrationSpec {
