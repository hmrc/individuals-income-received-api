...
case class AmendForeignDividendItem(countryCode: String,
...
object AmendForeignDividendItem {
  implicit val reads: Reads[AmendForeignDividendItem] = Json.reads[AmendForeignDividendItem]

  implicit val writes: OWrites[AmendForeignDividendItem] = (
