...
package v1andv2.models.request.amendDividends

import play.api.libs.functional.syntax._
import play.api.libs.json.{JsPath, Json, OWrites, Reads}

case class AmendDividendIncomeReceivedWhilstAbroadItem(countryCode: String,
...
object AmendDividendIncomeReceivedWhilstAbroadItem {
  implicit val reads: Reads[AmendDividendIncomeReceivedWhilstAbroadItem] = Json.reads[AmendDividendIncomeReceivedWhilstAbroadItem]

  implicit val writes: OWrites[AmendDividendIncomeReceivedWhilstAbroadItem] = (
