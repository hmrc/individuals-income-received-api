...
case class CreateAmendCgtResidentialPropertyDisposalsAuditDetail(userType: String,
...
object CreateAmendCgtResidentialPropertyDisposalsAuditDetail {
  ...
  def apply(userDetails: UserDetails,
            ...
            request: JsValue,
            `X-CorrelationId`: String,
            auditResponse: AuditResponse): CreateAmendCgtResidentialPropertyDisposalsAuditDetail = {
