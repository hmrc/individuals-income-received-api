...
import v1.connectors.{DeleteInsurancePoliciesConnector, DesUri}
...
class DeleteInsurancePoliciesService @Inject()(connector: DeleteInsurancePoliciesConnector) extends DesResponseMappingSupport with Logging {
