...
object AmendSavingsRequestBody {
  ...
  implicit val writes: Writes[AmendSavingsRequestBody] = (
    (JsPath \ "securities").writeNullable[AmendSecuritiesItems] and
      (JsPath \ "foreignInterest").writeNullable[Seq[AmendForeignInterest]]
