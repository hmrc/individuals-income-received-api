...
case class VoidedIsa(customerReference: String,
                     event: Option[String],
...
object VoidedIsa {
  ...
  implicit val reads: Reads[VoidedIsa] = Json.reads[VoidedIsa]

  implicit val writes: OWrites[VoidedIsa] = (
