...
object BonusIssuesOfSecurities {
  implicit val reads: Reads[BonusIssuesOfSecurities] = Json.reads[BonusIssuesOfSecurities]

  implicit val writes: OWrites[BonusIssuesOfSecurities] = (
    (JsPath \ "customerReference").writeNullable[String] and
      (JsPath \ "grossAmount").write[BigDecimal]
    ) (unlift(BonusIssuesOfSecurities.unapply))
}
