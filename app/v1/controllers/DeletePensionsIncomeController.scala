...
@Singleton
class DeletePensionsIncomeController @Inject() (val authService: EnrolmentsAuthService,
                                                val lookupService: MtdIdLookupService,
                                                requestParser: DeletePensionsIncomeRequestParser,
                                                service: DeletePensionsIncomeService,
  ...
  implicit val endpointLogContext: EndpointLogContext =
    EndpointLogContext(
      controllerName = "DeletePensionsIncomeController",
      endpointName = "deletePensionsIncome"
    )
