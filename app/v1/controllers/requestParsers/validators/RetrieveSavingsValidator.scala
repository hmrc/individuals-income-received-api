...
class RetrieveSavingsValidator @Inject() (implicit appConfig: AppConfig) extends Validator[RetrieveSavingsRawData] {
  ...
  private def parameterFormatValidation: RetrieveSavingsRawData => List[List[MtdError]] = (data: RetrieveSavingsRawData) => {
    List(
  ...
  private def parameterRuleValidation: RetrieveSavingsRawData => List[List[MtdError]] = (data: RetrieveSavingsRawData) => {
    List(
