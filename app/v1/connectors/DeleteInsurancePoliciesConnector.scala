...
@Singleton
class DeleteInsurancePoliciesConnector @Inject() (val http: HttpClient, val appConfig: AppConfig)(implicit featureSwitches: FeatureSwitches)
    extends BaseDownstreamConnector {

  def deleteInsurancePolicies(request: DeleteInsurancePoliciesRequest)(implicit
      hc: HeaderCarrier,
      ec: ExecutionContext,
