...
import v1r7.controllers.requestParsers.AmendForeignRequestParser
...
import v1r7.services.{AmendForeignService, AuditService, EnrolmentsAuthService, MtdIdLookupService}
