...
import v1r7.controllers.requestParsers.AmendFinancialDetailsRequestParser
...
import v1r7.services.{AmendFinancialDetailsService, AuditService, EnrolmentsAuthService, MtdIdLookupService}
    ...
    authorisedAction(nino).async(parse.json) { implicit request =>
      ...
      val result =
        for {
          ...
          Ok(amendFinancialDetailsHateoasBody(appConfig, nino, taxYear, employmentId))
