...
package v1r7.models.request.amendPensions

import play.api.libs.functional.syntax._
import play.api.libs.json.{JsPath, Json, OWrites, Reads}

case class AmendForeignPensionsItem(countryCode: String,
...
object AmendForeignPensionsItem {
  implicit val reads: Reads[AmendForeignPensionsItem] = Json.reads[AmendForeignPensionsItem]

  implicit val writes: OWrites[AmendForeignPensionsItem] = (
