...
import api.controllers.{FlattenedAuditHandler, RequestContext}
...
object FlattenedGenericAuditDetail {
  ...
  def auditDetailCreator(params: Map[String, String]): FlattenedAuditHandler.FlattenedAuditDetailCreator[GenericAuditDetail] =
    new FlattenedAuditHandler.FlattenedAuditDetailCreator[GenericAuditDetail] {
