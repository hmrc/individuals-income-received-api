...
import v1r6.connectors.AmendForeignConnector
...
@Singleton
class AmendForeignService @Inject()(connector: AmendForeignConnector) extends DesResponseMappingSupport with Logging {
