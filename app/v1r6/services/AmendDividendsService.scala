...
import v1r6.connectors.AmendDividendsConnector
...
@Singleton
class AmendDividendsService @Inject()(connector: AmendDividendsConnector) extends DesResponseMappingSupport with Logging {
