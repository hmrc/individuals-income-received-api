...
import v1andv2.models.request.createAmendUkSavingsAnnualSummary.{CreateAmendUkSavingsAnnualSummaryRawData, CreateAmendUkSavingsAnnualSummaryRequest}
...
trait MockCreateAmendUkSavingsAnnualSummaryRequestParser extends MockFactory {
  ...
  object MockCreateAmendUkSavingsAnnualSummaryRequestParser {
    ...
    def parse(data: CreateAmendUkSavingsAnnualSummaryRawData): CallHandler[Either[ErrorWrapper, CreateAmendUkSavingsAnnualSummaryRequest]] =
      (mockCreateAmendUkSavingsAnnualSummaryRequestParser
        .parseRequest(_: CreateAmendUkSavingsAnnualSummaryRawData)(_: String))
        .expects(data, *)
