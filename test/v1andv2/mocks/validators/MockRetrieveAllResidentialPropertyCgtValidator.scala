...
import v1andv2.controllers.requestParsers.validators.RetrieveAllResidentialPropertyCgtValidator
import v1andv2.models.request.retrieveAllResidentialPropertyCgt.RetrieveAllResidentialPropertyCgtRawData

trait MockRetrieveAllResidentialPropertyCgtValidator extends MockFactory {

  val mockRetrieveAllResidentialPropertyCgtValidator: RetrieveAllResidentialPropertyCgtValidator = mock[RetrieveAllResidentialPropertyCgtValidator]
