...
import v1andv2.controllers.requestParsers.validators.RetrieveOtherCgtValidator
...
trait MockRetrieveOtherCgtValidator extends MockFactory {
  ...
  val mockRetrieveOtherCgtValidator: RetrieveOtherCgtValidator = mock[RetrieveOtherCgtValidator]
