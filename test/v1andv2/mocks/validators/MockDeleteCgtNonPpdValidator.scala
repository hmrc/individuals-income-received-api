...
import v1andv2.controllers.requestParsers.validators.DeleteCgtNonPpdValidator
...
trait MockDeleteCgtNonPpdValidator extends MockFactory {
  ...
  val mockDeleteCgtNonPpdValidator: DeleteCgtNonPpdValidator = mock[DeleteCgtNonPpdValidator]
