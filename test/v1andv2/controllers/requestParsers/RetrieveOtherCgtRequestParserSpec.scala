...
import v1andv2.mocks.validators.MockRetrieveOtherCgtValidator
...
class RetrieveOtherCgtRequestParserSpec extends UnitSpec {
  ...
  trait Test extends MockRetrieveOtherCgtValidator {

    lazy val parser: RetrieveOtherCgtRequestParser = new RetrieveOtherCgtRequestParser(
      validator = mockRetrieveOtherCgtValidator
    )
