...
import api.models.errors.{ClassOfSharesAcquiredFormatError, ClassOfSharesAwardedFormatError, CustomerRefFormatError, DateFormatError, EmployerNameFormatError, EmployerRefFormatError, NinoFormatError, RuleIncorrectOrEmptyBodyError, RuleLumpSumsError, RuleTaxYearNotSupportedError, RuleTaxYearRangeInvalidError, SchemePlanTypeFormatError, TaxYearFormatError, ValueFormatError}
import config.AppConfig
import mocks.MockAppConfig
import play.api.libs.json.{JsValue, Json}
import play.api.mvc.AnyContentAsJson
import support.UnitSpec
import v1r7.requestParsers.validators.validations.ValueFormatErrorMessages
import v1r7.models.request.amendOtherEmployment.AmendOtherEmploymentRawData
