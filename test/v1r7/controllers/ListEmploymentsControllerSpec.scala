...
import v1r7.fixtures.ListEmploymentsControllerFixture._
import v1r7.hateoas.HateoasLinks
import v1r7.mocks.MockIdGenerator
import v1r7.mocks.hateoas.MockHateoasFactory
import v1r7.mocks.requestParsers.MockListEmploymentsRequestParser
import v1r7.mocks.services.{MockEnrolmentsAuthService, MockListEmploymentsService, MockMtdIdLookupService}
import v1r7.models.errors._
import v1r7.models.hateoas.Method.{GET, POST}
import v1r7.models.hateoas.RelType.{ADD_CUSTOM_EMPLOYMENT, SELF}
import v1r7.models.hateoas.{HateoasWrapper, Link}
import v1r7.models.outcomes.ResponseWrapper
import v1r7.models.request.listEmployments.{ListEmploymentsRawData, ListEmploymentsRequest}
import v1r7.models.response.listEmployment.{Employment, ListEmploymentHateoasData, ListEmploymentResponse}
