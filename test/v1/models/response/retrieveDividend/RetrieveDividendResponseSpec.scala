...
class RetrieveDividendResponseSpec extends UnitSpec {
  ...
  private val responseModel = RetrieveDividendResponse(
  ...
  "RetrieveDividendResponse" when {
    "read from valid JSON" should {
      "produce the expected RetrieveDividendResponse object" in {
        json.as[RetrieveDividendResponse] shouldBe responseModel
      }
    }
  }

  "read from empty JSON" should {
    "produce an empty RetrieveDividendResponse object" in {
      val emptyJson = JsObject.empty

      emptyJson.as[RetrieveDividendResponse] shouldBe RetrieveDividendResponse.empty
    }
  }
  ...
  "read from valid JSON with empty foreignDividend and dividendIncomeReceivedWhilstAbroad arrays" should {
    "produce an empty RetrieveDividendResponse object" in {
      ...
      json.as[RetrieveDividendResponse] shouldBe RetrieveDividendResponse.empty
    }
  }
  ...
  "read from invalid JSON" should {
    "produce a JsError" in {
      ...
      invalidJson.validate[RetrieveDividendResponse] shouldBe a[JsError]
    }
  }
