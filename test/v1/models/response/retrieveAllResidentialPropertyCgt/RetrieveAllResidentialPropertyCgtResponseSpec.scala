...
import v1r6.models.response.retrieveAllResidentialPropertyCgt.{CustomerAddedDisposals, Disposals, MultiplePropertyDisposals, PpdService, RetrieveAllResidentialPropertyCgtResponse, SinglePropertyDisposals}
