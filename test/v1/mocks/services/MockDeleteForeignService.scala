...
import v1.services.{DeleteForeignService, DeleteForeignServiceOutcome}
...
trait MockDeleteForeignService extends MockFactory {
  ...
  object MockDeleteForeignService {

    def deleteForeign(requestData: DeleteForeignRequest): CallHandler[Future[DeleteForeignServiceOutcome]] = (
