...
trait MockListUkSavingsAccountsConnector extends MockFactory {
  ...
  object MockListUkSavingsAccountsConnector {
    ...
    def listUkSavingsAccounts(
        requestData: ListUkSavingsAccountRequest): CallHandler[Future[DownstreamOutcome[ListUkSavingsAccountResponse[UkSavingsAccount]]]] = {
      (mockListUkSavingsAccountsConnector
        .listUkSavingsAccounts(_: ListUkSavingsAccountRequest)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(requestData, *, *, *)
    }
