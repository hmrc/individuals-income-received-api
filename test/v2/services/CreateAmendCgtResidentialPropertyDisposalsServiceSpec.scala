...
import v2.fixtures.residentialPropertyDisposals.CreateAmendCgtResidentialPropertyDisposalsServiceConnectorFixture.requestBody
import v2.mocks.connectors.MockCreateAmendCgtResidentialPropertyDisposalsConnector
    ...
    "createAndAmend" must {
      ...
      "map errors according to spec" when {
        ...
        val errors = List(
          ...
          ("INVALID_DISPOSAL_DATE", RuleDisposalDateErrorV2),
