...
import v1r6.controllers.requestParsers.validators.CreateAmendCgtResidentialPropertyDisposalsValidator
...
trait MockCreateAmendCgtResidentialPropertyDisposalsValidator extends MockFactory {
  ...
  val mockCreateAmendCgtResidentialPropertyDisposalsValidator: CreateAmendCgtResidentialPropertyDisposalsValidator =
    mock[CreateAmendCgtResidentialPropertyDisposalsValidator]

  object MockCreateAmendCgtResidentialPropertyDisposalsValidator {

    def validate(data: CreateAmendCgtResidentialPropertyDisposalsRawData): CallHandler1[CreateAmendCgtResidentialPropertyDisposalsRawData, List[MtdError]] = {
