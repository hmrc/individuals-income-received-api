...
package v1r6.fixtures.residentialPropertyDisposals

import v1r6.models.request.createAmendCgtResidentialPropertyDisposals.{Disposal, CreateAmendCgtResidentialPropertyDisposalsRequestBody}
