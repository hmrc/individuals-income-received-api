...
import v1r6.mocks.requestParsers.MockDeleteRetrieveRequestParser
import v1r6.mocks.services.{MockDeleteRetrieveService, MockEnrolmentsAuthService, MockMtdIdLookupService}
import v1r6.models.domain.Nino
import v1r6.models.errors.{BadRequestError, DownstreamError, ErrorWrapper, MtdError, NinoFormatError, NotFoundError, RuleTaxYearNotSupportedError, RuleTaxYearRangeInvalidError, TaxYearFormatError}
import v1r6.models.hateoas.{HateoasWrapper, Link}
import v1r6.models.hateoas.Method.{DELETE, GET, PUT}
import v1r6.models.hateoas.RelType.{CREATE_AND_AMEND_OTHER_CGT_AND_DISPOSALS, DELETE_OTHER_CGT_AND_DISPOSALS, SELF}
import v1r6.models.outcomes.ResponseWrapper
import v1r6.models.request.{DeleteRetrieveRawData, DeleteRetrieveRequest}
import v1r6.models.response.retrieveOtherCgt.{Disposal, Losses, NonStandardGains, RetrieveOtherCgtHateoasData, RetrieveOtherCgtResponse}
