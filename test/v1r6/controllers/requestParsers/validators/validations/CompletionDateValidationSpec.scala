  ...
  "validate" should {
    "return NoValidationErrors" when {
      "date is after 7th March and before today in the current tax year" in {
        MockCurrentDateTime.getLocalDate.returns(LocalDate.parse("2020-04-01"))
      ...
      "date is after 7th March and before today in the previous tax year" in {
        MockCurrentDateTime.getLocalDate.returns(LocalDate.parse("2020-04-01"))
        MockCurrentDateTime.getDateTime.returns(DateTime.parse("2020-04-01"))
        CompletionDateValidation.validate("2020-03-08", "path", "2019-20")(mockCurrentDateTime) shouldBe NoValidationErrors
      }
      "date is before 7th March and before today in thee previous tax year" in {
        MockCurrentDateTime.getLocalDate.returns(LocalDate.parse("2020-05-01"))
        MockCurrentDateTime.getDateTime.returns(DateTime.parse("2020-05-01"))
    ...
    "return an error" when {
      ...
      "date is after 7th March and after today in the current tax year" in {
        MockCurrentDateTime.getLocalDate.returns(LocalDate.parse("2020-03-01"))
        MockCurrentDateTime.getDateTime.returns(DateTime.parse("2020-03-01"))
      ...
      "date is after 7th March and in the next tax year" in {
        MockCurrentDateTime.getLocalDate.returns(LocalDate.parse("2019-04-01"))
        MockCurrentDateTime.getDateTime.returns(DateTime.parse("2019-04-01"))
        CompletionDateValidation.validate("2020-03-08", "path", "2019-20")(mockCurrentDateTime) shouldBe List(
          RuleCompletionDateError.copy(paths = Some(Seq("path")))
        )
      }
