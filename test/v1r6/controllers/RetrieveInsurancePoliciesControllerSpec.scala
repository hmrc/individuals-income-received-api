...
import v1r6.fixtures.RetrieveInsurancePoliciesControllerFixture
...
import v1r6.models.response.retrieveInsurancePolicies._
    ...
    "return OK" when {
      "happy path" in new Test {
        ...
        MockDeleteRetrieveService
          .retrieve[RetrieveInsurancePoliciesResponse](defaultDownstreamErrorMap)
