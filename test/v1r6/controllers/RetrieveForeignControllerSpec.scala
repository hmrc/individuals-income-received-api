...
import v1r6.fixtures.foreign.RetrieveForeignFixture
...
import v1r6.models.hateoas.RelType.{AMEND_FOREIGN_INCOME, DELETE_FOREIGN_INCOME, SELF}
...
import v1r6.models.response.retrieveForeign.{ForeignEarnings, RetrieveForeignHateoasData, RetrieveForeignResponse, UnremittableForeignIncome}
    ...
    "return OK" when {
      "happy path" in new Test {
        ...
        MockDeleteRetrieveService
          .retrieve[RetrieveForeignResponse](defaultDownstreamErrorMap)
